...
import { LogOut, BarChart3, Trophy, Users } from "lucide-react";

const navItems = [
  { name: "Dashboard", href: "/gerente/dashboard", icon: BarChart3 },
  { name: "Competições", href: "/gerente/competicoes", icon: Trophy },
  { name: "Minha Equipe", href: "/gerente/equipe", icon: Users },
];
